...
//PlayCrapsOnce takes no input parameters and returns true or false depending on 
// outcome of a single simulated game of craps.
...
//ComputeHouseEdge takes an integer numTrials and returns an estimate of the house edge
//  of craps (or whatever binary game) played over numTrials simulated games.
